...
import { apiFetch, apiFetchImage } from "@/lib/api";
import { TransformWrapper, TransformComponent } from "react-zoom-pan-pinch";
import { UploadCloud, FileText, Download, Trash2, Loader2, File as FileIcon, ZoomIn, ZoomOut, Maximize } from "lucide-react";
...
export const GestionArchivosDialog = ({ isOpen, onClose, evento }: GestionArchivosDialogProps) => {
    ...
    const handleUpload = async () => {
        ...
        try {
            const response = await apiFetchImage(`/eventos/${evento.id_evento}/archivos`, formData, {
                method: 'POST',
            });
                                                    ...
                                                    >
                                                        ...
                                                        <TableCell className="text-right">
                                                            <Button
                                                                ...
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    handleDownload(archivo.id_archivo, archivo.nombre_original);
                                                                }}
                                                            >
                                                                <Download size={16} />
                                                            </Button>
                                                            <Button
                                                                ...
                                                                onClick={(e) => {
                                                                    e.stopPropagation();
                                                                    handleDelete(archivo.id_archivo);
                                                                }}
                                                            >
