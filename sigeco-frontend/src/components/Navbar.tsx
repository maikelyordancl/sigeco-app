  ...
  return (
    <nav className="bg-blue-600 text-white px-4 py-3 flex justify-between items-center shadow-md sticky top-0 z-50">
      ...
      <div className="hidden md:flex space-x-6 items-center">
          ...
          {openMenu === "eventos" && (
            <div className="absolute bg-white text-black shadow-lg rounded mt-2 p-2 space-y-2 animate-fade-in">
              <Button
                ...
                onClick={() => router.push("/eventos/gestion")}
              >
                Gestión de Eventos
              </Button>
              <Button
                variant="ghost"
                className="w-full justify-start"
                onClick={() => router.push("/subeventos/gestion")}
              >
                Subeventos
              </Button>
            </div>
          ...
          {openMenu === "contactos" && (
            <div className="absolute bg-white text-black shadow-lg rounded mt-2 p-2 space-y-2 animate-fade-in">
              <Button
                variant="ghost"
                className="w-full justify-start"
                onClick={() => router.push("/contactos/gestion")}
              >
                Gestión
              </Button>
              <Button
                variant="ghost"
                className="w-full justify-start"
                onClick={() => router.push("/contactos/base-datos")}
              >
                Bases de Datos
              </Button>
            </div>
          ...
          {openMenu === "convocatoria" && (
            <div className="absolute bg-white text-black shadow-lg rounded mt-2 p-2 space-y-2 animate-fade-in">
              <Button
                variant="ghost"
                className="w-full justify-start"
                onClick={() => router.push("/convocatoria/campanas")}
              >
                Campañas
              </Button>
              <Button
                variant="ghost"
                className="w-full justify-start"
                onClick={() => router.push("/dashboard/convocatoria/influencers")}
              >
                Influencers
              </Button>
              <Button
                variant="ghost"
                className="w-full justify-start"
                onClick={() => router.push("/dashboard/convocatoria/whatsapp")}
              >
                WhatsApp
              </Button>
            </div>
            ...
            {openMenu === "admin" && (
              <div className="absolute bg-white text-black shadow-lg rounded mt-2 p-2 space-y-2 animate-fade-in">
                <Button
                  variant="ghost"
                  className="w-full justify-start"
                  onClick={() => router.push("/admin/usuarios-y-roles")}
                >
                  Usuarios y Roles
                </Button>
                <Button
                  variant="ghost"
                  className="w-full justify-start"
                  onClick={() => router.push("/admin/permisos-por-evento")}
                >
                  Permisos por Evento
                </Button>
              </div>
        ...
        {/* --- NUEVO BOTÓN TESORERÍA --- */}
        <Button variant="ghost" onClick={() => router.push("/tesoreria")}>
          Tesorería
        </Button>

        <Button variant="ghost" onClick={() => router.push("/acreditacion")}>
          Acreditación
        </Button>

        <Button variant="ghost" onClick={() => router.push("/dashboard/reportes")}>
          Reportes
        </Button>
          ...
          <SheetContent side="left" className="bg-blue-600 text-white w-64">
            ...
            <Accordion type="single" collapsible className="w-full mt-4 space-y-2">
              ...
              <AccordionItem value="presupuesto">
                ...
                <AccordionContent>
                  <Button
                    variant="ghost"
                    className="w-full justify-start"
                    onClick={() => router.push("/dashboard/presupuesto/proyectos")}
                  >
                    Proyectos
                  </Button>
                  <Button
                    variant="ghost"
                    className="w-full justify-start"
                    onClick={() => router.push("/dashboard/presupuesto/educacion")}
                  >
                    Educación
                  </Button>
                  <Button
                    variant="ghost"
                    className="w-full justify-start"
                    onClick={() => router.push("/dashboard/presupuesto/congresos")}
                  >
                    Congresos y Ferias
                  </Button>
                  <Button
                    variant="ghost"
                    className="w-full justify-start"
                    onClick={() => router.push("/dashboard/presupuesto/servicios")}
                  >
                    Servicios
                  </Button>
                </AccordionContent>
              ...
              <Button
                variant="ghost"
                className="w-full justify-start"
                onClick={() => router.push("/dashboard/convocatoria")}
              >
                Convocatoria
              </Button>
              ...
              <Button
                variant="ghost"
                className="w-full justify-start"
                onClick={() => router.push("/acreditacion")}
              >
                Acreditación
              </Button>
