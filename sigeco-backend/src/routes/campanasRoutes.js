...
router.get(
  ...
  [
    param('id_evento')
      .isInt({ gt: 0 })
      .withMessage('El ID del evento debe ser un número válido.')
  ],
...
// GET /api/campanas/tesoreria/campanas
router.get(
  '/tesoreria/campanas',
  tesoreriaController.getCampanasParaTesoreria
);

// GET /api/campanas/tesoreria/:id_campana/asistentes
router.get(
  '/tesoreria/:id_campana/asistentes',
  [
    param('id_campana')
      .isInt({ gt: 0 })
      .withMessage('El ID de la campaña debe ser válido.')
  ],
...
router.put(
  ...
  tesoreriaController.updateEstadoPago
);
...
router.post(
  ...
  [
    body('id_evento')
      .isInt({ gt: 0 })
      .withMessage('El ID del evento es obligatorio.'),
    body('id_subevento')
      .isInt({ gt: 0 })
      .withMessage('El ID del subevento es obligatorio.'),
    body('nombre')
      .optional()
      .isString()
      .trim()
    ...
    body('url_amigable')
      ...
      .trim()
      .notEmpty()
      .withMessage('La URL amigable no puede estar vacía.')
      .matches(/^[A-Za-z0-9-]+$/)
      .withMessage('La URL amigable contiene caracteres no válidos.'),
...
router.put(
  ...
  [
    ...
    body('campos')
      .isArray()
      .withMessage('La configuración de campos debe ser un array.')
  ],
...
router.post(
  ...
  [
    param('id_campana')
      .isInt({ gt: 0 })
      .withMessage('El ID de la campaña no es válido.'),
    body('bases_origen')
      .isArray({ min: 1 })
      .withMessage('Debes seleccionar al menos una base de datos.'),
    body('bases_origen.*')
      .isInt()
      .withMessage('Los IDs de las bases de datos deben ser números.')
  ],
...
router.post(
  ...
  [
    ...
    body('contactos')
      .isArray({ min: 1 })
      .withMessage('Se requiere un arreglo de contactos.')
  ],
...
router.put(
  ...
  [
    param('id_campana').isInt({ gt: 0 }),
    body('landing_page_json')
      .isJSON()
      .withMessage('El contenido de la landing debe ser un JSON válido.')
  ],
...
router.put(
  ...
  [
    param('id_campana')
      .isInt({ gt: 0 })
      .withMessage('El ID de la campaña debe ser un número válido.'),
    body('emailSubject')
      .isString()
      .withMessage('El asunto es requerido.'),
    body('emailBody')
      .isString()
      .withMessage('El cuerpo del correo es requerido.')
  ],
...
router.put(
  ...
  [
    ...
    body('id_plantilla')
      .optional()
      .isInt({ min: 1, max: 2 })
      .withMessage('El ID de plantilla no es válido.'),
    body('fecha_personalizada')
      .optional({ nullable: true })
      .isString()
      .withMessage('La fecha personalizada debe ser un texto.')
...
// DELETE /api/campanas/asistentes/:id_inscripcion
router.delete(
  '/asistentes/:id_inscripcion',
  [
    param('id_inscripcion')
      .isInt({ gt: 0 })
      .withMessage('El ID de la inscripción debe ser un número válido.')
  ],
