...
router.get('/campanas', acreditacionController.getCampanasParaAcreditar);

// GET /api/acreditacion/campana/:id_campana/asistentes -> Obtiene los asistentes de una campaña (SOLO PARA USO DE ACREDITACION))
router.get(
